...
const FooterAbout = () => {
  ...
  return (
    ...
    >
      ...
      Young Star Trust empowers youth and women through affordable courses, employment programs, and skill-building workshops, fostering growth and unity in Agashi and beyond.
      </p>
      {isSecondary ? (
